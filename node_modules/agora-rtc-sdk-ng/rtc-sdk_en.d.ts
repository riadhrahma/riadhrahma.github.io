...
declare enum AgoraRTCErrorCode {
    ...
    LIVE_STREAMING_TRANSCODING_NOT_SUPPORT = "LIVE_STREAMING_TRANSCODING_NOT_SUPPORT",
 ...
 *
 * Each exception corresponds to a recovery event, see the table below for details:
 *
 ...
 * - `LIVE_STREAMING_TRANSCODING_NOT_SUPPORT`: Sets the transcoding parameters when the transcoding is not enabled.
...
export declare interface ILocalAudioTrack extends ILocalTrack {
     ...
     * > This method supports Chrome only. Other browsers throw a '`NOT_SUPPORT` error when calling this method.
